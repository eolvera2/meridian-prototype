 ...
 * - Has a pre-populated Referral Letter at the top (expanded, with content)
 * - Scrolls to the Referral Letter on load
...
function AppTask5Start() {
  ...
  // Expand the Referral Letter by default
  const initialExpandedDocuments = useMemo(
    () => new Set(["referral-task5"]),
    []
  );
