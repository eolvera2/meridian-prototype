 ...
 * - Has the Referral Letter expanded and pre-populated with content
 * - Has the Orders document expanded
...
function AppTask6Start() {
  ...
  // Create initial documents with pre-populated Referral Letter at the top
  ...
  // Expand both Referral Letter and Orders by default
  const initialExpandedDocuments = useMemo(
    () => new Set(["referral-task6", "orders-1"]),
    []
  );
